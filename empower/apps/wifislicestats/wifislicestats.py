...
SLICE_STATS_ENTRY = Struct(
    ...
    "current_empower_queue_length" / Int32ub,
    "current_empower_queue_num" / Int32ub,
    "current_empower_queue_max" / Int32ub,
    "quantum" / Int32ub,
    "aifsn" / Int32ub,
    "cwmin" / Int32ub,
    "cwmax" / Int32ub,
    ...
    def handle_response(self, response, *_):
        ...
        for entry in response.stats:
            ...
            self.stats[wtp][entry.iface_id] = {
                ...
                'current_empower_queue_length': entry.current_empower_queue_length,
                'current_empower_queue_num': entry.current_empower_queue_num,
                'current_empower_queue_max':  entry.current_empower_queue_max,
